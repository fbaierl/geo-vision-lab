...
async def export_ontology(thread_id: str):
    ...
    Returns:
        JSON file download
    """
    ontology_service = container.get(OntologyService)
    ontology = await ontology_service.load_ontology(thread_id)
...
async def import_ontology(
    ...
    ontology_service = container.get(OntologyService)
    current_ontology = await ontology_service.load_ontology(thread_id)
    ...
    await ontology_service.save_ontology(thread_id, final_ontology)
