...
class RAGConfig(BaseModel):
    ...
    reranker_candidates_k: int = Field(
        ..., description="Number of candidates for re-ranking"
    )
...
class RAGConfigUpdate(BaseModel):
    ...
    grader_enabled: Optional[bool] = Field(
        None, description="Enable/disable context grading"
    )
    reranker_enabled: Optional[bool] = Field(
        None, description="Enable/disable BGE re-ranker"
    )
