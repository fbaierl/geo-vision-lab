...
class ReRankerService:
    ...
    def _load_model(self) -> None:
        ...
        try:
            ...
            logger.warning("[RERANKER] Re-ranking will be disabled. Install with: pip install sentence-transformers")
            self._model = None
...
def get_reranker_service(model_name: str = "BAAI/bge-reranker-v2-m3") -> ReRankerService:
    """
