...
class TestExtractLocationsWithNER:
    ...
    def test_extract_locations_gpe(self):
        ...
        service = LocationExtractorService(ner_pipeline=mock_pipeline, geocode_cache={})
    ...
    def test_extract_locations_filters_non_locations(self):
        ...
        result = service.extract_locations_with_ner(
            "John Smith from Google visited Paris"
        )
...
class TestGeocodeLocation:
    ...
    def test_geocode_returns_multiple_candidates(self, mock_nominatim):
        ...
        service = LocationExtractorService(ner_pipeline=MagicMock(), geocode_cache={})
    ...
    def test_geocode_cache_hit(self):
        ...
        service = LocationExtractorService(
            ner_pipeline=MagicMock(), geocode_cache=cache
        )
...
class TestExtractAndGeocodeLocations:
    ...
    @patch(
        "app.services.location_extractor.LocationExtractorService.extract_locations_with_ner"
    )
