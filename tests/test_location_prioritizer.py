...
class TestPrioritizeLocations:
    ...
    @patch(
        "app.services.location_prioritizer.LocationPrioritizerService._fallback_prioritize"
    )
    def test_prioritize_with_valid_json_response(self, mock_fallback):
        ...
        locations = [
            ...
            },
            {
                ...
                "lat": 38.0,
                "lon": -122.0,
                "display_name": "Tehran, California, USA",
                "type": "city",
                "country": "United States",
            },
        ]
    ...
    def test_prioritize_with_invalid_json_response(self, mock_fallback):
        ...
        mock_response = AIMessage(
            content='[{"location_index": 0, "candidate_index": 0, "relevance": 1.0'
        )
        mock_llm.invoke.return_value = mock_response
        ...
        result = service.prioritize_locations(
            query="Test query", locations=locations, response_text="Test response"
        )
...
class TestExcludedLocations:
    ...
    def test_excluded_location_with_candidate_index_minus_one(self):
        ...
        result = service.prioritize_locations(
            "Tell me about Iran war", locations, "Response"
        )
